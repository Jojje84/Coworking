...
export function AdminBookings() {
  const { bookings, rooms, users, newBookingIds, deleteBooking } = useData();
  ...
  }, [bookings, rooms, users, searchQuery, filterStatus]);
        ...
        <div className="rounded-2xl border border-gray-100 bg-white p-6 shadow-sm">
          <div className="mb-5">
            ...
            <p className="mt-1 text-sm text-gray-500">
              Find bookings by room, username, email or status.
            </p>
          </div>
